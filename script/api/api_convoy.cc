...
vector_tpl<vehikel_desc_t const*> const& convoi_get_vehicles(convoi_t* cnv)
{
	static vector_tpl<vehikel_desc_t const*> v;
	v.clear();
	if (cnv) {
...
{
	// This simply cannot be done as static with Experimental's physics.
	//FIXME.
	return speed_limit;
