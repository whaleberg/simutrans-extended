...
public:
	...
	monorail_rail_vehicle_t(koord3d pos, const vehikel_desc_t* desc, player_t* player, convoi_t* cnv) : rail_vehicle_t(monorail_vehicle, pos, desc, player, cnv) {}
#else
	// all handled by rail_vehicle_t
...
public:
	...
	maglev_rail_vehicle_t(koord3d pos, const vehikel_desc_t* desc, player_t* player, convoi_t* cnv) : rail_vehicle_t(maglev_vehicle, pos, desc, player, cnv) {}
#else
	// all handled by rail_vehicle_t
...
public:
	...
	narrowgauge_rail_vehicle_t(koord3d pos, const vehikel_desc_t* desc, player_t* player, convoi_t* cnv) : rail_vehicle_t(narrowgauge_vehicle, pos, desc, player, cnv) {}
#else
	// all handled by rail_vehicle_t
